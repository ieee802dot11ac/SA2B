...
/************************************************************************************************/
/*
*   Material Chunk Constants
*/
/****** Material Colors *************************************************************************/
#define CNK_MAT_DIFF                (1) /* diffuse head flag                                    */
#define CNK_MAT_AMBI                (2) /* ambient head flag                                    */
#define CNK_MAT_SPEC                (4) /* specular head flag                                   */
...
#define CNK_WEIGHT_MUL_N2           (1.f/65535.f) /* weight multiply value for Ninja2           */
...
typedef struct
{
    Uint8 exp;                      /* specular exponent                                 [0~16] */
}
CNK_BITS_EXPONENT;
...
* 
*   Notes:
*     - User Flags appear each POLYGON, and NOT each INDEX. This means you must SKIP the first
*       two indexes when parsing strips, as a whole polygon hasn't been created until the 3rd
*       index.
*/
/****** User Flag Offsets ***********************************************************************/
typedef struct
...
typedef struct
{
    Sint16          len;            /* strip length                         [<0 -> rev winding] */
...
/*
*   Description:
*     Convert Ninja1 integer vertex weight value to 0.f~1.f.
*
*   Parameters:
*     - w           : weight value
*
...
/*
*   Description:
*     Convert Ninja2 integer vertex weight value to 0.f~1.f.
*
*   Parameters:
*     - w           : weight value
*
...
*     Weight value converted to 0.f~1.f.
*/
#define CNK_GET_WEIGHT_N2(w)        ((Float)(w)*CNK_WEIGHT_MUL_N2)
