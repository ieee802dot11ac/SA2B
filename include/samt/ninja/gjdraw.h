/*
*   SAMT for Sonic Adventure 2 (PC, 2012) - '/ninja/gjdraw.h'
*
*   Description:
*       Ginja draw module.
*/
...
extern Sint32 _gj_render_mode_;

/** Set render mode **/
void    gjSetRenderMode( Sint32 mode );

/****** Transform *******************************************************************/
void    gjTransformObject( const GJS_OBJECT* object, int(*callback)(const GJS_MODEL*) );
